...
class DatasetConfigParser:
    ...
    def get_classes(self) -> List[str]:
        ...
        try:
            ...
            logging.error(
                'Please specify a list of class names under the "classes" key in the dataset config file. '
    ...
    def get_class_color_mapping(self) -> Dict[str, str]:
        ...
        try:
            ...
            logging.error(
                'Please specify a class-to-color mapping for the dataset under the "colors" key in the '
                "dataset config file"
            )
            raise e
        return colors
